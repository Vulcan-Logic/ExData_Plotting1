...
#plot3.R
#submission for assignment of Week 1 - Part 3 of the Exploratory Data Analysis module of the data science course of coursera
...
#and save it as PNG file called plot3.png. 
...
png("plot3.png")                          #open the png device and file
...
#draw the supplemntary lines - additional data
...
axis(1,at=ax1,labels = al1)               #set the axis tick marks and labels
