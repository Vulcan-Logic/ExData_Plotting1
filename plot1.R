...
#plot2.R
#submission for assignment of Week 1 - Part 1 of the Exploratory Data Analysis module of the data science course of coursera
...
#and save it as PNG file called plot1.png. 
...
png("plot1.png")                                                     #open the png file and device
#make the histogram 
